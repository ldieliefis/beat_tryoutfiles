package com.example.iris.navigationdrawer2;
...
public class MainActivity extends AppCompatActivity
   ...
   /* }
    public void CreditPopUp(View view){
        ...
        credits.setMessage(getString(R.string.credits_message))
                .setPositiveButton(getString(R.string.credits_button), new DialogInterface.OnClickListener() {
                    @Override
